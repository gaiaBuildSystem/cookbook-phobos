...
# download the file depending on the architecture
_file = ""

if _ARCH == "linux/arm64":
    _file = "rac-aarch64"
elif _ARCH == "linux/amd64":
    _file = "rac-amd64"
else:
    raise Error_Out(f"Unknown architecture: {_ARCH}")
